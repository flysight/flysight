...
/** @property layoutManager
 *  @brief A flag to indicate that the layer is being rendered recursively.
 **/
...
/**	@brief Abstraction of Mac and iPhone event handling. Handles mouse or finger swipe event.
 *  @param event Native event object of device.
 *	@param interactionPoint The coordinates of the event in the host view.
 *  @return Whether the event was handled or not.
 **/
-(BOOL)pointingDeviceSwipeEvent:(id)event atPoint:(CGPoint)interactionPoint
{
	return NO;
}
